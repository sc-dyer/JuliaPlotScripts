...
T = range(0,1000)
Gand = -2588.67E3 .- (T.+273.15).*92.7
Gsil = -2585.79E3 .-(T.+273.15).*95.4

plot(T,Gand,size = [PLOTX,PLOTY],xlabel = "T (C)",ylabel = "G" ,xlim=[0,1000],legend = false,linewidth = 4, linecolor = "red",grid = false,xlabelfontsize = 24, ylabelfontsize = 24,framestyle = :box, tickfontsize = 16, tickdirection =:in)
plot!(T,Gsil, linewidth = 4, linecolor = "blue")

plot(T,Gsil-Gand,size = [PLOTX,PLOTY],xlabel = "T (C)",ylabel = "G" ,xlim=[0,1000],legend = false,linewidth = 4, linecolor = "red",grid = false,xlabelfontsize = 24, ylabelfontsize = 24,framestyle = :box, tickfontsize = 16, tickdirection =:in)
