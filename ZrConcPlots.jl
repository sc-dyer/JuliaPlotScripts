...
set_theme!(myTheme)
update_theme!(;aspect = 1, resolution = (1000,1000))
# update_theme!(;Axis = (;ylims = (10E-2,10E3)))
#                     xminorticksize = 0,
#                     xminortickwidth = 0)
fig = Figure()
sam20SD06 = plotZrConc(raw"C:\Users\Sabas\OneDrive - University of Waterloo\Documents\Waterloo\LAICPMS\2023_09_20\20SD06_ZrTable.csv",fig)

sam20SD17A = plotZrConc(raw"C:\Users\Sabas\OneDrive - University of Waterloo\Documents\Waterloo\LAICPMS\2023_09_20\20SD17A_ZrTable.csv",fig)
sam20SD06.ylabel = "Average Zr concentration (μg/g)"
hideydecorations!(sam20SD17A, ticks = false, minorticks = false)
sam21SD68 = plotZrConc(raw"C:\Users\Sabas\OneDrive - University of Waterloo\Documents\Waterloo\LAICPMS\2023_09_20\21SD68_ZrTable.csv",fig)
sam22SD55E = plotZrConc(raw"C:\Users\Sabas\OneDrive - University of Waterloo\Documents\Waterloo\LAICPMS\2023_09_20\22SD55E_ZrTable.csv",fig)
